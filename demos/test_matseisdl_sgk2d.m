...
L = 6;
seed=201517;
dc=dl_hevents(dt,f0,tmax,h,tau,v0,amp,snr,L,seed);dc=dl_scale(dc,2);
...
tic
[d1]=dl_sgk_denoise(d,mode,[l1,l2,1],[s1,s2,1],perc,param);
toc
...
tic
d2=dl_ksvd_denoise(d,mode,[l1,l2,1],[s1,s2,1],perc,param);
toc
