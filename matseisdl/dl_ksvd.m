function [D,G]=dl_ksvd(X,param)
%dl_ksvd: K-SVD algorithm
% BY Yangkang Chen
% Jan, 2020
% 
% INPUT
...
function [ g ] = dl_omp0( D, x, K )
% dl_omp0: Most basic orthogonal matching pursuit for sparse coding
