...
function [dout,Dksvd,Gksvdc,DCT]=dl_ksvd_denoise(din,mode,l,s,perc,param)
%dl_ksvd_denoise: K-SVD algorithm for 2D and 3D denoising
% BY Yangkang Chen
% Jan, 2020
...
%KSVD
if n3==1
    X=dl_patch(din,mode,l1,l2,s1,s2);
    [Dksvd,Gksvd]=dl_ksvd(X,param);
    Gksvdc=Gksvd;
    Gksvd=dl_pthresh(Gksvdc,'ph',perc);
    X2=Dksvd*Gksvd;
    dout=dl_patch_inv(X2,mode,n1,n2,l1,l2,s1,s2);
else
    X=dl_patch3d(din,mode,l1,l2,l3,s1,s2,s3);
    [Dksvd,Gksvd]=dl_ksvd(X,param);
    Gksvdc=Gksvd;
    Gksvd=dl_pthresh(Gksvdc,'ph',perc);
    X2=Dksvd*Gksvd;
    dout=dl_patch3d_inv(X2,mode,n1,n2,n3,l1,l2,l3,s1,s2,s3);
end
