...
function [dout]=dl_ksvd_recon(d0,mask,mode,l,s,perc,niter,a,param)
%dl_ksvd_recon: K-SVD algorithm for 2D/3D reconstruction
% BY Yangkang Chen
% Jan, 2020
%
% INPUT
...
%
% DEMO: 
% test/test_dl_ksvd_recon.m
% test/test_dl_ksvd_recon3d.m
...
if n3==1
    ...
    Gksvdc=Gksvd;
    Gksvd=dl_pthresh(Gksvdc,'ph',perc);
    X2=Dksvd*Gksvd;
